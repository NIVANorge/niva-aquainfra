...
class NivaTilePlotProcessor(BaseProcessor):
    ...
    def __init__(self, processor_def):
        ...
        with open(config_file_path, 'r') as config_file:
            ...
            self.image_name = "ferry-rscripts:20260916-0d266b5"
    ...
    def _execute(self, data):
        ...
        # Check existence:        
        # "raise_for_status returns error when sending http request" --> more detail needed,
        # worked in tests in April 2026
        ...
        # Output filename
        out_result_path = f'{output_dir}/ferrybox_tile_{self.job_id}.png'
        out_result_url  = f'{output_url}/ferrybox_tile_{self.job_id}.png'
