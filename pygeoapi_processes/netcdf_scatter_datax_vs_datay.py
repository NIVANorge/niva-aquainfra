...
class NivaNetcdfScatterDataxVsDatayProcessor(BaseProcessor):
    ...
    def __repr__(self):
        return f'<NivaNetcdfScatterDataxVsDatayProcessor> {self.name}'
    ...
    def _execute(self, data):
        ...
        # Output filename
        out_result_path = f'{output_dir}/scatter_{self.job_id}.png'
        out_result_url  = f'{output_url}/scatter_{self.job_id}.png'
